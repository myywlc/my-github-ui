...
I18N.zh = {
  ...
  pubilc: {
    ...
    regexp: [
       ...
       */
      [
        /(Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May(?:)?|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?) (\d+)(?:, (\d+)|)/g,
        function(all, month, date, year) {
          var monthKey = {
            Jan: '1月',
            Feb: '2月',
            Mar: '3月',
       ...
       */
      [
        /just now|(an?|\d+) (second|minute|hour|day|month|year)s? ago/,
        function(m, d, t) {
          if (m === 'just now') {
            return '刚刚';
          }
  ...
  'page-dashboard': {
    ...
    static: {
      ...
      'Using the Hello World guide, you’ll create a repository, start a branch,':
        '使用 Hello World 指南，您将创建一个仓库，开始一个分支，',
      ...
      'After you switch contexts you’ll see an organization-focused dashboard that lists out organization repositories and activities.':
        '当您切换身份，您会看到一个组织为中心的页面，其中列出了组织库和活动。',
    },
    regexp: [
      // 正则翻译
  ...
  'page-profile': {
    ...
    static: {
      ...
      'Updating your profile with your name, location, and a profile picture helps other GitHub users get to know you.':
        '更新您的资料信息包括姓名，地址，头像等资料，让其他用户更容易的了解您。',
  ...
  'page-account': {
    ...
    static: {
      ...
      'Get credit for all your work by showing the number of contributions to private repositories on your profile without any repository or organization information.':
        '显示所有包括私人仓库的贡献到您的个人资料页面，不包括组织仓库信息。',
      ...
      'Once you delete your account, there is no going back. Please be certain.':
        '一旦您删除了帐户，就没办法恢复，请三思而行。',
      'Delete your account': '确认删除',

      // Emails 菜单
      Your: '您的',
      'primary GitHub email address': 'GitHub Email 主帐户',
      'will be used for account-related notifications (e.g. account changes and billing receipts) as well as any web-based GitHub operations (e.g. edits and merges).':
        '将被用于接收相关通知 (例如：账单信息)，以及任何基于 web 的 GitHub 操作 (例如：编辑或合并操作)。',
      Primary: '主帐户',
      Private: '私有',
      Public: '公开',
      ...
      'We will use': '我们将使用',
      'when performing web-based Git operations and sending email on your behalf. If you want command line Git operations to use your private email you must':
        '作为默认"发件人"地址以您的名义发送电子邮件。如果您想在命令行 Git 的操作中使用您的私人邮件地址，您必须在',
      ...
      'This is a list of devices that have logged into your account. Revoke any sessions that you do not recognize.':
        '这是您登陆的设备会话列表，如果不是您本人操作，可以关闭该会话。',
      ...
      'Personal access tokens function like ordinary OAuth access tokens. They can be used instead of a password for Git over HTTPS, or can be used to':
        '访问令牌功能类似于OAuth，他可以代替密码给 Git Https 访问，',
      ...
      'Any user-specific information (OAuth tokens, SSH keys, Job Profile, etc) will be erased':
        '任何用户特定的信息（OAuth tokens, SSH keys, Job Profile, 等）将被删除。',
      'create a new personal account': '创建一个新的个人帐户',
    },
    regexp: [
      // 正则翻译
      [
        /This email will not be used as the 'from' address for web-based GitHub operations - we will instead use ([^@]+@users.noreply.github.com)./,
        '该邮箱不会被用作 "发件人"地址，我们会改用 ($1) 作为默认 "发件人"地址。',
      ],
      ...
      [
        ...
        '您将不能作为账户登录到 $1。（所有管理权限将赋予您选择的所有者）',
      ],
      [
        /Any commits credited to (\w+) will no longer be linked to this GitHub account/,
        '任何提交归功于 $1 将不再链接到这个 GitHub 帐户',
      ],
  ...
  'page-new-repo': {
    ...
    static: {
      ...
      'A repository contains all the files for your project, including the revision history.':
        '仓库包含项目中的所有文件，包括修订历史记录。',
      Owner: '创建者',
      'Repository name': '仓库名',
      'Great repository names are short and memorable. Need inspiration? How about':
        '一个好的仓库名应该是简单容易被记住的，需要来点灵感吗？这个名字怎么样',
      Description: '描述',
      '(optional)': '(可选)',
      Public: '公共 (免费)',
      'Anyone can see this repository. You choose who can commit.':
        '任何人都可以看到这个仓库，您可以选择谁能提交。',
      Private: '私有 (收费)',
      ...
      'This will let you immediately clone the repository to your computer. Skip this step if you’re importing an existing repository.':
        '这将让您可以立刻克隆该仓库到您的电脑。如果您要提交已有的仓库，请忽略这个选项。',
      'Add .gitignore:': '添加 .gitignore 文件',
      'Filter ignores…': '筛选忽略文件…',
      'Add a license:': '添加发布许可',
      'Filter licenses…': '筛选许可…',
      None: '无',
      'Need help picking a license? We’ve built a site just for you.':
        '需要帮您挑选一个许可吗？我们为您供了参考页面。',
  ...
  'vis-public': {
    ...
    static: {
      ...
      'There is no need to keep this window open, we’ll email you when the import is done.':
        '没有必要在这个窗口傻等，当导入完成时，我们会向您发送电子邮件。',
      ...
      'Yowza, that’s a big file. Try again with a file smaller than 25MB.':
        '我勒个擦，这么大的文件，单文件不得超过25MB',
      'Yowza, that’s a lot of files. Try again with fewer than 100 files.':
        '我勒个擦，这么多文件，一次不能超过100个',
      ...
      'Create a new pull request by comparing changes across two branches. If you need to, you can also':
        '通过比较两个分支的更改来创建一个新的拉请求。如果需要，还可以',
      'Able to merge.': '可被合并。',
      ...
      'Choose two branches to see what’s changed or to start a new pull request. If you need to, you can also':
        '选择两个分支，看看发生了什么改变，或发起一个新的拉请求。如果你需要，你也可以',
      'base fork:': '基派生:',
      ...
      'GitHub Wikis is a simple way to let others contribute content. Any GitHub user can create and edit pages to use for documentation, examples, support, or anything you wish.':
        'GitHub Wikis 是一个简单的方法让别人贡献内容。GitHub 的任何用户都可以创建和编辑页面中使用的文档，示例，支持或任何您想。',
      ...
      'Replace your existing site by using our automatic page generator. Author your content in our Markdown editor, select a theme, then publish.':
        '通过使用我们的自动页面生成器替换现有的网站。您可以在我们的 Markdown 编辑器，选择一个主题，然后发布。',
      ...
      '— Unavailable for your site because you have a custom domain configured (':
        '- 无法为您的网站开启，因为您配置了一个自定义域名 (',
      'HTTPS provides a layer of encryption that prevents others from snooping on or tampering with traffic to your site.':
        'HTTPS 提供了一层加密，防止他人偷窥或篡改的交通到您的网站。',
      'When HTTPS is enforced, your site will only be served over HTTPS.':
        '当开启强制 HTTPS 后，您的网站将只能通过 HTTPS 访问。',
      ...
      'The default branch is considered the “base” branch in your repository, against which all pull requests and code commits are automatically made, unless you specify a different branch.':
        '默认分支被认为是“基地”分支在您的资料库，对所有拉取请求和代码的提交是自动进行的，除非您指定一个不同的分支。',
      Update: '更新',
      ...
      'Protect branches to disable force pushing, prevent branches from being deleted, and optionally require status checks before merging. New to protected branches?':
        '受保护分支禁用强制推送，避免删除分支机构，合并可选要求前状态检查。创建新的受保护的分支机构？',
      'Learn more.': '查看更多信息',
      ...
      'You can initialize this repository with code from a Subversion, Mercurial, or TFS project.':
        '您可以初始化此仓库从一个 Subversion，Mercurial 或 TFS 项目。',
      'Import code': '导入代码',
    ...
    regexp: [
      ...
      [
        /Save (.+?) to your computer and use it in GitHub Desktop./,
        '使用 GitHub 桌面版，保存 $1 到您的电脑。',
      ],
      [/([\d,]+) Open/, '$1 个开放的'],
      [/([\d,]+) Closed/, '$1 个关闭的'],
  ...
  homepage: {
    ...
    static: {
      ...
      'Millions of developers use GitHub to build personal projects, support their businesses, and work together on open source technologies.':
        '数以百万计的开发人员使用 GitHub 建立个人项目，支持他们的企业，共同在开放源码技术。',

      'Introducing unlimited': '引入无限制的',
      'private repositories': '私人仓库',
      'All of our paid plans on GitHub.com now include unlimited private repositories.':
        '所有在我们 GitHub.com 上的付费用户，我们将提供无限制的私人仓库。',
      'Sign up': '注册',
      ...
      'GitHub fosters a fast, flexible, and collaborative development process that lets you work on your own or with others.':
        'GitHub 提供了一个快速，灵活和协作开发过程，让您对自己或与他人合作。',
      ...
      'Host and manage your code on GitHub. You can keep your work private or share it with the world.':
        '主机和管理您的代码在 GitHub 上。您可以把您的工作或私人与世界分享。',
      ...
      'From hobbyists to professionals, GitHub helps developers simplify the way they build software.':
        '从业余爱好者到专业人士，GitHub 帮助开发人员简化的方式构建软件。',
      ...
      'GitHub is home to millions of open source projects. Try one out or get inspired to create your own.':
        'GitHub 是数百万开源项目的家园。尝试一个或获得灵感来创造您自己的项目。',
      ...
      'With hundreds of integrations, GitHub is flexible enough to be at the center of your development process.':
        '成百上千的集成，GitHub 是足够灵活的，能够在您的发展过程的中心。',
      ...
      'Use GitHub to create a personal project, whether you want to experiment with a new programming language or host your life’s work.':
        '使用 GitHub 来创建一个个人项目，不管您想要尝试一个新的编程语言或主机在您生活及工作。',
      Communities: '社区',
  ...
  signup: {
    ...
    static: {
      ...
      'This will be your username — you can enter your organization’s username next.':
        '这将是您的用户名 - 也可以是您组织或公司的名称。',
      'Email Address': 'Email 地址',
      'You will occasionally receive account related emails. We promise not to share your email with anyone.':
        '该邮箱用于接收相关的通知邮件。我们承诺不公开您的电子邮件给任何人。',
      Password: '密码',
  ...
  notifications: {
    ...
    static: {
      ...
      ', you’ll see updates here for your conversations in watched repositories.':
        '，您将看到您关注仓库的更新信息。',
    },
    regexp: [
      // 正则翻译
  ...
  gist: {
    ...
    static: {
      ...
      'Secret gists are hidden from search engines but visible to anyone you give the URL.':
        '私有片段搜索引擎是搜不到的，但是您可以分享您的 url 给他们。',
